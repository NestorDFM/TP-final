...
public class FormCiudad extends javax.swing.JDialog {
    ...
    private String [] columnas = new String[]{"ID","NOMBRE","ISO"};
    private DefaultTableModel dtmCiudad= new DefaultTableModel(null,columnas);
    ...
    private void recuperarCiudades(){
        listaCiudad=ciudadDao.consultarCiudades();
        cargarTabla();
    }
